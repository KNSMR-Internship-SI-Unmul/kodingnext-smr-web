        ...
        <div className="relative max-w-6xl mx-auto px-6 lg:px-16 w-full flex justify-end">
          <div className="relative p-8 rounded-xl max-w-md bg-white/60 backdrop-blur-sm border border-white/20 shadow-2xl">
            ...
            <div className="flex gap-3">
              ...
              <button className="bg-white border-[1.5px] border-primary-purple text-primary-purple px-4 py-2 rounded-lg text-sm font-medium hover:bg-hover-purple hover:border-hover-purple hover:text-white transition-colors">
                Lihat Proyek
              </button>
            </div>
          </div>

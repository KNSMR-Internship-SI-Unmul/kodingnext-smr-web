...
export default function RoboNext() {
  ...
  useEffect(() => {
    document.title = "RoboNext | Koding Next Samarinda";
        ...
        <div className="relative max-w-6xl mx-auto px-16 w-full flex justify-end">
          ...
          >
            ...
            <div className="flex gap-3">
              ...
              <button className="bg-white border border-primary-purple text-primary-purple px-4 py-2 rounded-lg text-sm font-medium hover:bg-hover-purple hover:text-white">
                Lihat Proyek
              </button>
            </div>
          </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-10 px-4">
          {ageCategories.map((age) => (
            <button
              ...
              className={`border-2 border-primary-purple px-6 py-2 rounded-lg font-medium transition-colors ${
                selectedAge === age

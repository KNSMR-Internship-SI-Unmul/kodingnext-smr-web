...
export default function JuniorKoders() {
  ...
  const filteredModules = modules
    .filter((c) => c.modules === 'Little Koders')
    .sort((a, b) => a.id - b.id);
  ...
  const ageCategories = [...new Set(
    filteredModules.map((c) => c.age_range)
  )];
  ...
  const projectList = filteredProjects.length > 0 ? filteredProjects : studentProjects;
                  ...
                  <div className="w-[calc(50%-20px)] flex justify-end items-center pr-2">
                    {side === 'left' && (
                      ...
                      >
                        ...
                        <div className="absolute -left-6 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-primary-blue rounded-full shadow-md flex items-center justify-center text-white font-semibold text-3xl">
                          {displayNumber}
                        </div>
                        <div className="bg-white p-8 h-30 rounded-2xl shadow-xl border-2 border-gray-200 border-b-4 border-b-primary-blue flex flex-col items-center justify-center text-center transition-all duration-200 group-hover:scale-105 group-hover:shadow-2xl group-hover:border-primary-blue">
                          <h3 className="text-primary-blue font-semibold text-xl mb-1">{m.name}</h3>
                  ...
                  <div className="w-[calc(50%-20px)] flex justify-start items-center pl-2">
                    {side === 'right' && (
                      ...
                      >
                        ...
                        {/* GANTI m.id MENJADI displayNumber */}
                        <div className="absolute -right-6 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-primary-blue rounded-full shadow-md flex items-center justify-center text-white font-semibold text-3xl">
                          {displayNumber}
                        </div>
                      </button>
                    )}
